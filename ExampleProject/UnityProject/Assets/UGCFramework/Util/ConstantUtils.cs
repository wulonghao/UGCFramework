...
namespace UGCF.Utils
{
    ...
    {
        public static string BundleIdentifier { get => Application.identifier; }
        public static string BundleDirectory { get => Application.dataPath + "/Editor Default Resources/AssetBundle/"; }
