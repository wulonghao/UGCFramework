                                ...
                                IPointerUpHandler
{
    ...
    public void OnPointerDown(PointerEventData eventData)
    {
        ...
        if (onLongPress != null && this && gameObject && gameObject.activeInHierarchy)
        {
    ...
    public void OnPointerUp(PointerEventData eventData)
    {
        ...
        if (longPressCoroutine != null && this && gameObject && gameObject.activeInHierarchy)
            StopCoroutine(longPressCoroutine);
    }
    ...
    public void OnPointerEnter(PointerEventData eventData)
    {
        ...
        if (onStayData != null && this && gameObject && gameObject.activeInHierarchy)
        {
