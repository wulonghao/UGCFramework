...
namespace UGCF.Utils
{
    ...
    {
        public static string BundleIdentifier => Application.identifier;
        public static string BundleDirectory => Application.dataPath + "/Editor Default Resources/AssetBundle/";
        public static string AssetBundleFolderPath => Application.persistentDataPath + "/AssetBundle/";
        ...
        public const string ONE_CLICK_LOGIN_3 = "检测到移动网络未开启，请开启移动网络后重试";
