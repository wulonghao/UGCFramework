...
namespace UGCF.Manager
{
    public class ShareManager : MonoBehaviour
    {
        ...
        public void WechatShareImage(WechatShareScene scene, Texture2D shareImage)
        {
            ...
            ExtendDeclaration.ShareImageWx_iOS((int)scene, array, data.Length, arrayThumb, dataThumb.Length);
#elif UNITY_ANDROID
        ...
        {
#if UNITY_IOS
            ExtendDeclaration.ShareTextWx_iOS((int)scene, content);
#elif UNITY_ANDROID
            AndroidJavaClass utils = new AndroidJavaClass(WeChatShareUtils);
        ...
        public void WechatShareUrl(WechatShareScene scene, string url, string title, Texture2D shareThumbIcon, string content)
        {
            ...
            ExtendDeclaration.ShareUrlWx_iOS((int)scene, url, title, content, arrayThumb, thumb.Length);
#elif UNITY_ANDROID
            AndroidJavaClass utils = new AndroidJavaClass(WeChatShareUtils);
...
#if UNITY_IOS
            ExtendDeclaration.ShareUrlByQQ(title, content, imagePath, url);
#elif UNITY_ANDROID
        ...
        public void QQShareImage(Texture2D shareImg)
        {
            ...
            {
#if UNITY_IOS
                ExtendDeclaration.ShareImgByQQ(ConstantUtils.PrintScreenPath);
#elif UNITY_ANDROID
                AndroidJavaClass utils = new AndroidJavaClass(QQShareUtils);
