...
namespace UGCF.Manager
{
    public class ThirdPartySdkManager : MonoBehaviour
    {
...
#elif UNITY_IOS
            ExtendDeclaration.RegisterApp_iOS(WXAppID, WXAppSecret);
#elif UNITY_ANDROID
        ...
        public bool IsWechatInstalled()
        {
            ...
            isRegister = false;
#elif UNITY_IOS
        isRegister = ExtendDeclaration.IsWechatInstalled_iOS();
#elif UNITY_ANDROID
        AndroidJavaClass wechatTool = new AndroidJavaClass(WechatToolStr);
...
#elif UNITY_IOS
        ExtendDeclaration.OpenWechat_iOS("app_wechat");
#elif UNITY_ANDROID
...
#else
#if UNITY_IOS
        isRegister = ExtendDeclaration.IsQQInstalled_iOS();
#elif UNITY_ANDROID
...
#elif UNITY_IOS
            ExtendDeclaration.InitQQ(QQAppID);
#elif UNITY_ANDROID
            AndroidJavaClass qqTool = new AndroidJavaClass(QQToolStr);
        ...
        {
#if UNITY_IOS
            ExtendDeclaration.RequestApplePay(skuId);
#endif
        }
        ...
        public void CopyToClipboard(string input)
        {
            ...
            t.Copy();
#elif UNITY_IOS
            ExtendDeclaration.CopyTextToClipboard_iOS(input);  
#elif UNITY_ANDROID
