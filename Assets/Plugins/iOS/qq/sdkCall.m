...
- (void)logout { [_oauth logout:self]; }
...
- (NSArray *)getAuthorizedPermissions:(NSArray *)permissions withExtraParams:(NSDictionary *)extraParams { return nil; }
...
- (void)responseDidReceived:(APIResponse*)response forMessage:(NSString *)message{
    if (nil == response || nil == message) { return; }
    NSDictionary *userInfo = [NSDictionary dictionaryWithObjectsAndKeys: response, kResponse, message, kMessage, nil];
...
- (BOOL)onTencentResp:(TencentApiResp *)resp{ return NO; }
...
- (BOOL)onTencentReq:(TencentApiReq *)req{ return NO; }

#pragma mark - 旋转
- (BOOL) tencentWebViewShouldAutorotateToInterfaceOrientation:(UIInterfaceOrientation)toInterfaceOrientation{ return YES; }
